    ...
    <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-8">
            ...
            <div class="group relative rounded-2xl border border-slate-800/60 bg-slate-900/30 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-slate-700/80 hover:bg-slate-900/50 hover:shadow-2xl hover:-translate-y-0.5"
                 style="--accent: <?php echo e($exp['accent']); ?>">
                ...
                <div class="absolute inset-y-0 left-0 w-[3px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-l-2xl"
                     style="background: linear-gradient(to bottom, <?php echo e($exp['accent']); ?>, transparent)"></div>
                ...
                <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none rounded-2xl"
                     style="background: radial-gradient(ellipse at top left, <?php echo e($exp['accent']); ?>0d 0%, transparent 60%)"></div>
                ...
                <div class="relative p-6 md:p-8">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="hidden sm:block text-5xl font-black font-mono text-slate-800 group-hover:text-slate-700 transition-colors select-none leading-none">
                                <?php echo e($exp['index']); ?>

                            </span>

                            
                            <div class="flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center font-mono font-black text-sm ring-1 <?php echo e($exp['ring']); ?> <?php echo e($exp['badge_bg']); ?> transition-transform duration-300 group-hover:scale-110">
                                <?php echo e($exp['initials']); ?>
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-0.5 text-xs text-slate-400 font-mono">
                                    ...
                                    <span><?php echo e($exp['location']); ?></span>
                                    <span class="text-slate-700">·</span>
                                    <span class="<?php echo e($exp['badge_bg']); ?> px-2 py-0.5 rounded-full text-[10px] font-semibold tracking-wide"><?php echo e($exp['type']); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex-shrink-0 flex items-center gap-2 self-start">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($exp['dot']); ?> flex-shrink-0 <?php if($exp['to'] === 'Present'): ?> animate-pulse <?php endif; ?>"></span>
                    ...
                    <div class="mb-5 pl-0 sm:pl-20">
                        <h4 class="text-2xl font-extrabold text-white tracking-tight"><?php echo e($exp['role']); ?></h4>
                    </div>
                    ...
                    <div class="sm:pl-20 grid lg:grid-cols-12 gap-6 lg:gap-10">
                        ...
                        <ul class="lg:col-span-8 space-y-3">
                            <?php $__currentLoopData = $exp['bullets']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $bullet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-start gap-3 text-slate-300 text-sm leading-relaxed">
                                <span class="mt-1.5 flex-shrink-0 w-1.5 h-1.5 rounded-full" style="background:<?php echo e($exp['accent']); ?>"></span>
                        ...
                        <div class="lg:col-span-4 grid grid-cols-3 lg:grid-cols-1 gap-3">
                            <?php $__currentLoopData = $exp['stats']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex flex-col items-center lg:items-start justify-center bg-slate-800/40 border border-slate-800 rounded-xl px-3 py-3 lg:flex-row lg:gap-4 lg:py-2.5">
                                <span class="text-xl lg:text-lg font-black font-mono" style="color:<?php echo e($exp['accent']); ?>"><?php echo e($stat['value']); ?></span>
                                <span class="text-[10px] text-slate-500 uppercase tracking-wider font-mono mt-0.5 lg:mt-0"><?php echo e($stat['label']); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/zabir/my-app/resources/views/experience.blade.php ENDPATH**/ ?>