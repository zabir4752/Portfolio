                    ...
                    <div class="grid lg:grid-cols-12 gap-12 items-center">
                        <div class="lg:col-span-7">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="<?php echo e(route('projects')); ?>" class="px-8 py-3.5 rounded-lg text-white bg-brand-600 hover:bg-brand-500 shadow-lg hover:shadow-brand-500/25 transition-all font-medium text-sm sm:text-base flex items-center">
                                    View Projects
                                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                                </a>
                                <a href="<?php echo e(route('contact')); ?>" class="px-8 py-3.5 rounded-lg text-white bg-slate-800 hover:bg-slate-700 transition-all font-medium text-sm sm:text-base border border-slate-700">
                                    Contact Me
                                </a>
                                <a href="<?php echo e(asset('files/zabir_cv.jpg')); ?>" download="Zabir_Bin_Abu_Bakar_CV.jpg" class="px-8 py-3.5 rounded-lg text-slate-300 hover:text-white transition-all font-medium text-sm sm:text-base flex items-center group">
                                    Download CV
                        ...
                        <div class="lg:col-span-5 flex justify-center lg:justify-end mt-12 lg:mt-0 relative">
                            ...
                            <div class="relative w-64 sm:w-80 lg:w-[22rem] aspect-[4/5] rounded-2xl overflow-hidden bg-slate-900 border border-slate-800 shadow-2xl group flex items-center justify-center">
                                <img src="<?php echo e(asset('images/zabir_nobg.png')); ?>" alt="Zabir Bin Abu Bakar" class="w-full h-full object-cover object-[center_10%] -translate-x-6 scale-[1.8] filter grayscale-[80%] opacity-90 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-[1.9] transition-all duration-700 z-10 relative">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/zabir/my-app/resources/views/home.blade.php ENDPATH**/ ?>