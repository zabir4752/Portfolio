                        ...
                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="glass-card rounded-2xl overflow-hidden flex flex-col group hover:shadow-[0_0_30px_rgba(2,132,199,0.15)] transition-all duration-500 border border-slate-700/50 hover:border-brand-500/30">
                                ...
                                <div class="h-48 bg-slate-900 relative overflow-hidden">
                                    <img src="<?php echo e(asset('images/projects/' . $project['image'])); ?>" alt="<?php echo e($project['title']); ?>" class="w-full h-full object-cover opacity-80 group-hover:scale-110 group-hover:opacity-100 transition-all duration-700">
                                ...
                                <div class="p-8 flex flex-col flex-grow">
                                    <h3 class="text-xl font-bold text-white mb-3 group-hover:text-brand-400 transition-colors"><?php echo e($project['title']); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/zabir/my-app/resources/views/projects.blade.php ENDPATH**/ ?>